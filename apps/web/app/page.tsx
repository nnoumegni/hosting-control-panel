    ...
    <PublicLayout>
      ...
      <div className="ot-hero-wrapper hero-2" id="hero2">
        ...
        <div className="hero-bg-line1">
          ...
          <div className="line"></div>
          <div className="line"></div>
          <div className="line hidden sm:block"></div>
          <div className="line hidden sm:block"></div>
          <div className="line hidden sm:block"></div>
          <div className="line hidden sm:block"></div>
          <div className="line hidden sm:block"></div>
          ...
          <div className="flex justify-center text-center">
            <div className="w-full">
              <div className="hero-style2">
                ...
                <div className="btn-wrap justify-center" data-cue="slideInUp" data-delay="400">
      ...
      {/* Feature Area */}
      <section className="feature-area-1 relative z-10">
        <div className="container">
      ...
      {/* About Section */}
      <div className="about-sec2 relative overflow-hidden space" id="about-sec">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-10">
            ...
            <div>
              <div className="about-wrap2">
                ...
                <div className="btn-wrap mt-8" data-cue="slideInUp">
        ...
        <div className="container">
          ...
          <div className="flex flex-col items-center">
            {[
              ...
              <div key={idx} className="w-full service-list-wrap" data-cue="slideInUp">
